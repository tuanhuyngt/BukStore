...
export class AuthorServiceProxy {
     ...
     * @return Success
     */
    aUTHOR_Insert(input: AuthorInsertDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Author/AUTHOR_Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAUTHOR_Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAUTHOR_Insert(<any>response_);
                } catch (e) {
    ...
    protected processAUTHOR_Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    aUTHOR_Del(ma: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Author/AUTHOR_Del?";
        if (ma !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAUTHOR_Del(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAUTHOR_Del(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processAUTHOR_Del(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    aUTHOR_Search(input: AuthorSearchDto | null | undefined): Observable<AuthorSearchDto[]> {
        let url_ = this.baseUrl + "/api/Author/AUTHOR_Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAUTHOR_Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAUTHOR_Search(<any>response_);
                } catch (e) {
                    return <Observable<AuthorSearchDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<AuthorSearchDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processAUTHOR_Search(response: HttpResponseBase): Observable<AuthorSearchDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<AuthorSearchDto[]>(<any>null);
    }
}
...
export class AuthorInsertDto implements IAuthorInsertDto {
    author_Name!: string;
    author_Gender!: string | undefined;
    author_Birth!: number | undefined;
    author_Des!: string | undefined;

    constructor(data?: IAuthorInsertDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AuthorInsertDto {
        data = typeof data === 'object' ? data : {};
        let result = new AuthorInsertDto();
        result.init(data);
        return result;
    }
...
export interface IAuthorInsertDto {
    author_Name: string;
    author_Gender: string | undefined;
    author_Birth: number | undefined;
    author_Des: string | undefined;
