...
using BukStore.AbpZeroTemplate.Authorization.Users.Profile.Cache;
using BukStore.AbpZeroTemplate.Authorization.Users.Profile.Dto;
using BukStore.AbpZeroTemplate.Friendships;
using BukStore.AbpZeroTemplate.Identity;
using BukStore.AbpZeroTemplate.Security;
using BukStore.AbpZeroTemplate.Storage;
using BukStore.AbpZeroTemplate.Timing;

namespace BukStore.AbpZeroTemplate.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AbpZeroTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("BukStore.AbpZeroTemplate",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("BukStore.AbpZeroTemplate",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
