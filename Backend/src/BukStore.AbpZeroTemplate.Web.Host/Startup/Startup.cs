...
using BukStore.AbpZeroTemplate.Web.Chat.SignalR;
using BukStore.AbpZeroTemplate.Web.IdentityServer;
using Hangfire;
...
namespace BukStore.AbpZeroTemplate.Web.Startup
{
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("BukStore.AbpZeroTemplate.Web.wwwroot.swagger.ui.index.html");
            }); //URL: /swagger
        }
    }
}
