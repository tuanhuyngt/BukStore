...
using BSWebsite.AbpZeroTemplate.Application.Share.DemoModels;
...
namespace BSWebsite.AbpZeroTemplate.Web.Core.DemoModels
{
    ...
    public class DemoModelAppService : BSWebsiteAppServiceBase, IDemoModelAppService
    {
