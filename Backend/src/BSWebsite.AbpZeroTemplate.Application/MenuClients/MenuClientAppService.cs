...
using BSWebsite.AbpZeroTemplate.Application.Share.MenuClients;
...
namespace BSWebsite.AbpZeroTemplate.Application.MenuClients
{
    [AbpAuthorize(BSWebsitePermissions.Pages_Administration_MenuClient)]
    public class MenuClientAppService : BSWebsiteAppServiceBase, IMenuClientAppService
    {
        ...
        [AbpAuthorize(BSWebsitePermissions.Pages_Administration_MenuClient_Create)]
        ...
        [AbpAuthorize(BSWebsitePermissions.Pages_Administration_MenuClient_Edit)]
        ...
        [AbpAuthorize(BSWebsitePermissions.Pages_Administration_MenuClient_Delete)]
