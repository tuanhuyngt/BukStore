...
{
    public abstract class BSWebsiteDbContext<TTenant, TRole, TUser, TSelf> : AbpZeroDbContext<TTenant, TRole, TUser, TSelf>
        where TTenant : AbpTenant<TUser>
        where TRole : AbpRole<TUser>
        where TUser : AbpUser<TUser>
        where TSelf : BSWebsiteDbContext<TTenant, TRole, TUser, TSelf>
    {
        ...
        protected BSWebsiteDbContext(DbContextOptions<TSelf> options)
            : base(options)
        {
